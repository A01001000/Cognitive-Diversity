...
# Generates 2nd half of training dataset WITHOUT COMBINED TRAPS with injected Spurious Correlation Breakers to prevent models from learning unrelated patterns in vocabulary, tone, or syntax. This is the "Anti-Correlated" version of the original dataset.
...
def generate_dataset(num_batches=5, num_baseline=2, output_file="datasets/sep_inverted_dataset_500.json"):
    dataset = []
    ...
    print(f"Generating {num_batches} Anti-Correlated Adversarial Batches (4 scenarios each)...")
...
if __name__ == "__main__":
    # Generates ~102 batches (approx 500 samples) to match and offset your previous 500 samples
